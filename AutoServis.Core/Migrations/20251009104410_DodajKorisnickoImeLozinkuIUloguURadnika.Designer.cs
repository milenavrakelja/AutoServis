...
namespace AutoServis.Core.Migrations
{
    ...
    [Migration("20251009104410_DodajKorisnickoImeLozinkuIUloguURadnika")]
    partial class DodajKorisnickoImeLozinkuIUloguURadnika
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoServis.Core.Models.Racun", b =>
                {
                    ...
                    b.HasOne("AutoServis.Core.Models.Rezervacija", null)
                        .WithMany("Racuni")
            ...
            modelBuilder.Entity("AutoServis.Core.Models.Rezervacija", b =>
                {
                    ...
                    b.HasOne("AutoServis.Core.Models.Status", null)
                        .WithMany("Rezervacije")
            ...
            modelBuilder.Entity("AutoServis.Core.Models.Usluga", b =>
                {
                    ...
                    b.HasOne("AutoServis.Core.Models.TipUsluge", null)
                        .WithMany("Usluge")
